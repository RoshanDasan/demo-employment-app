...
import { Container, Paper, Typography, Grid, TextField, Button, Chip } from '@mui/material';
      ...
      <Paper elevation={3} sx={{ padding: '20px' }}>
        ...
        <form onSubmit={formik.handleSubmit}>
          <Grid container spacing={2}>
            ...
            {isSignup && (
              <>
                ...
                <Grid item xs={12}>
                  ...
                  />
                  <Button variant="contained" color="primary" onClick={handleAddHobby}>
                    Add Hobby
                  </Button>
            ...
            <Grid item xs={12}>
              <Button fullWidth variant="outlined" color="primary" onClick={handleToggleForm}>
